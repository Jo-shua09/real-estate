    ...
    <div className="w-full h-full section">
      ...
      <div className="w-full flex items-center flex-col gap-10 mt-16">
        ...
        <div className="w-full flex gap-10">
          ...
          <div className="border-2 p-10 rounded-xl flex-[3] w-full h-full flex flex-col gap-y-7 border-white/5 bg-hero">
            <div className="flex items-center justify-between gap-6">
              <h3 className="text-3xl font-semibold">Unlock the Value of Your Property Today</h3>
              <button className="py-4 px-7 capitalize rounded-xl flex items-center font-semibold bg-black/30 text-2xl border-2 border-white/5">
                learn more
              </button>
            </div>
