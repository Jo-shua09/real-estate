    ...
    <div className="w-full h-full">
      <div className="">
        {results.length === currentPage ? (
          <div className="section-page mt-10">
            <SectionIntro
        ...
        {results.length === currentPage ? (
          <div className="w-full justify-center flex mt-10">
            <button
              ...
              className="bg-purple-600 capitalize hover:scale-95 text-white font-bold py-4 px-6 rounded-lg text-2xl"
            >
          ...
          <div className="w-full flex justify-center mt-10">
            <button onClick={loadMore} className="bg-purple-600 capitalize hover:scale-95 text-white font-bold py-4 px-6 rounded-lg text-2xl">
