  ...
  return (
    <div className="w-full section">
      ...
      <div className="w-full flex flex-col gap-5 mt-20">
        ...
        <div className="flex mt-5 flex-wrap md:flex-nowrap items-center justify-between gap-10 w-full">
          <div className="md:flex-1 w-full rounded-xl border-2 border-white/5 p-10">
            ...
            <h3 className="text-4xl md:text-3xl py-7 font-semibold">123 Estantien Plaza, City Center, Metropolis</h3>
          ...
          <div className="md:flex-1 w-full rounded-xl border-2 border-white/5 p-10">
            ...
            <h3 className="text-4xl md:text-3xl py-7 font-semibold">456 Urban Avenue, Downtown District, Metropolis</h3>
            <p className="text-2xl font-medium normal-case text-white/70">
