    ...
    <div className="w-full my-20 !mb-0 border-2 border-l-0 border-r-0 border-white/5 overflow-x-hidden">
      <div className="relative w-full h-full">
        <div className="flex justify-between w-full">
          <img src={bannerLeft} alt="banner left image" className="w-fit h-[32rem] md:h-[28rem]" />

          <img src={bannerRight} alt="banner left image" className="w-fit h-[32rem] md:h-[28rem]" />
        </div>
